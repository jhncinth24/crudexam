...
<header class="max-w-lg max-auto">
    <h1 class="text-3xl font-bold text-white text-center uppercase">Add New Student</h1>
</header>
    ...
    <section class="mt-10">
        <form action="/add/student" method="POST" class="flex flex-col">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                focus:outline-none border-b-4 border-gray-400 px-3" value={{old('first_name')}}>
                @error('first_name')
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                focus:outline-none border-b-4 border-gray-400 px-3" value={{old('last_name')}}>
                @error('last_name')
                    <p class="text-red-500 text-xs p-1">
                        {{ $message }}
                    </p>
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                focus:outline-none border-b-4 border-gray-400 px-3" value={{old('age')}}>
                @error('age')
                    <p class="text-red-500 text-xs p-1">
                        {{ $message }}
                    </p>
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                focus:outline-none border-b-4 border-gray-400 px-3" value={{old('email')}}>
                @error('email')
                    <p class="text-red-500 text-xs p-1">
                        {{ $message }}
                    </p>
